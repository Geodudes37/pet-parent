...
//this url will be re-worked
 const url = 'http://localhost:8080/api/...${petType}/${gender}/${color}/${zipCode}'
    ...
    <div className="form-container">
        ...
        >
            ...
            <div className="dropdown">
                ...
                id="dropdown-1"
                className="select"
                onChange={(e)=>{changeHandler(e, 'petType')}}
            ...
            <div className="zip-code">
                ...
                <input type="text" 
                onChange={(e)=>{changeHandler(e, 'zipCode')}}
                />
            </div>
            {/* submit button */}
            <button>
